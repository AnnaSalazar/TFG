...
Comunament, es considera que el dia està format per 5 intervals de temps segons la posició del sol: la matinada (de les 0 a les 5 h incloses), el matí (de les 6 a les 11 h incloses), el migdia (de les 12 a les 14 h incloses), la tarda (de les 15 a les 19 h incloses) i la nit (de les 20 a les 23 h incloses). S'han fet servir aquests intervals per definir les categories que es mostren a la dreta de la figura 6.
