...
a1 <- descr(accident[, 2], transpose = TRUE, stats = c("N.Valid", "min", "q1", "med", "mean", "sd", "q3", "max", "iqr"), style = "rmarkdown", justify = "center")
rownames(a1) <- NULL

a2 <- descr(accident[, 3], transpose = TRUE, stats = c("N.Valid", "min", "q1", "med", "mean", "sd", "q3", "max",
                                                       "iqr"), style = "rmarkdown", justify = "center")
rownames(a2) <- NULL

a3 <- descr(accident[, 6], transpose = TRUE, stats = c("N.Valid", "min", "q1", "med", "mean", "sd", "q3", "max",
                                                       "iqr"), style = "rmarkdown", justify = "center")
rownames(a3) <- NULL

a4 <- descr(accident[, 7], transpose = TRUE, stats =  c("N.Valid", "min", "q1", "med", "mean", "sd", "q3", 
                                                        "max", "iqr"), style = "rmarkdown", justify = "center")
rownames(a4) <- NULL

a5 <- descr(accident[, 8], transpose = TRUE, stats = c("N.Valid", "min", "q1", "med", "mean", "sd", "q3", 
                                                       "max", "iqr"), style = "rmarkdown", justify = "center")
rownames(a5) <- NULL

a6 <- descr(accident[, 9], transpose = TRUE, stats = c("N.Valid", "min", "q1", "med", "mean", "sd", "q3", "max",
                                                       "iqr"), style = "rmarkdown", justify = "center")
rownames(a6) <- NULL

a7 <- descr(accident[, 10], transpose = TRUE, stats = 
...
```{r, results='asis', echo=FALSE}
a1 <- descr(persones[, 2], transpose = TRUE, stats = c("N.Valid", "min", "q1", "med", "mean", "sd", "q3", "max", "iqr"), style = "rmarkdown", justify = "center")
rownames(a1) <- NULL

a2 <- descr(persones[, 3], transpose = TRUE, stats = c("N.Valid", "min", "q1", "med", "mean", "sd", "q3", "max",
                                                       "iqr"), style = "rmarkdown", justify = "center")
rownames(a2) <- NULL

a3 <- descr(persones[, 6], transpose = TRUE, stats = c("N.Valid", "min", "q1", "med", "mean", "sd", "q3", "max",
                                                       "iqr"), style = "rmarkdown", justify = "center")
rownames(a3) <- NULL

a4 <- descr(persones[, 7], transpose = TRUE, stats =  c("N.Valid", "min", "q1", "med", "mean", "sd", "q3", 
                                                        "max", "iqr"), style = "rmarkdown", justify = "center")
rownames(a4) <- NULL

a5 <- descr(persones[, 8], transpose = TRUE, stats = c("N.Valid", "min", "q1", "med", "mean", "sd", "q3", 
                                                       "max", "iqr"), style = "rmarkdown", justify = "center")
rownames(a5) <- NULL

a6 <- descr(persones[, 9], transpose = TRUE, stats = c("N.Valid", "min", "q1", "med", "mean", "sd", "q3", "max",
                                                       "iqr"), style = "rmarkdown", justify = "center")
rownames(a6) <- NULL

a7 <- descr(persones[, 10], transpose = TRUE, stats = 
             c("N.Valid", "min", "q1", "med", "mean", "sd", "q3", "max", "iqr"),
           style = "rmarkdown", justify = "center")
rownames(a7) <- NULL

a8 <- descr(persones[, 11], transpose = TRUE, stats = c("N.Valid", "min", "q1", 
                                                        "med", "mean", "sd", "q3", 
                                                        "max", "iqr"),
           style = "rmarkdown", justify = "center")
rownames(a8) <- NULL

a9 <- descr(persones[, 12], transpose = TRUE, stats = c("N.Valid", "min", "q1", 
                                                        "med", "mean", "sd", 
                                                        "q3", "max", "iqr"),
           style = "rmarkdown", justify = "center")
rownames(a9) <- NULL
