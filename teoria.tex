...
Per a utilitzar aquesta eina és necessari disposar d’un compte a Google. Per accedir a la pàgina, naveguem \href{https://datastudio.google.com}{a aquesta pàgina} i iniciem sessió amb el nostre compte de Google. Un cop dins de Data Studio, es troba una pantalla d’inici amb les característiques següents:
...
\subsection{Sobre el paquet `bigrquery`}
